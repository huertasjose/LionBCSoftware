...
class TablaRendimientoWidget extends StatefulWidget {
  ...
  static String routeName = 'TablaRendimiento';
  static String routePath = '/tablaRendimiento';
...
class _TablaRendimientoWidgetState extends State<TablaRendimientoWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'TablaRendimiento'});
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              '2jjy47y8' /* Rendimiento de Empleados */,
            ),
                      ...
                      StreamBuilder<List<TransaccionesRecord>>(
                        stream: queryTransaccionesRecord(
                          queryBuilder: (transaccionesRecord) =>
                              transaccionesRecord.orderBy('fecha',
                                  descending: true),
                        ),
                        builder: (context, snapshot) {
                          ...
                          List<TransaccionesRecord>
                              listViewTransaccionesRecordList = snapshot.data!;

                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewTransaccionesRecordList.length,
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          15.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        listViewTransaccionesRecord.monto
                                            .toString(),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
