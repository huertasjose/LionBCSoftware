...
import 'lista_pedidos_model.dart';
export 'lista_pedidos_model.dart';

class ListaPedidosWidget extends StatefulWidget {
  const ListaPedidosWidget({super.key});

  static String routeName = 'listaPedidos';
  static String routePath = '/listaPedidos';

  @override
  State<ListaPedidosWidget> createState() => _ListaPedidosWidgetState();
}

class _ListaPedidosWidgetState extends State<ListaPedidosWidget>
    with TickerProviderStateMixin {
  late ListaPedidosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaPedidosModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'listaPedidos'});
