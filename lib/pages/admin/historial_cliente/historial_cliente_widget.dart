...
class HistorialClienteWidget extends StatefulWidget {
  ...
  static String routeName = 'HistorialCliente';
  static String routePath = '/historialCliente';

  @override
  State<HistorialClienteWidget> createState() => _HistorialClienteWidgetState();
}
...
class _HistorialClienteWidgetState extends State<HistorialClienteWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'HistorialCliente'});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CitasRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CitasRecord> historialClienteCitasRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final historialClienteCitasRecord =
            historialClienteCitasRecordList.isNotEmpty
                ? historialClienteCitasRecordList.first
                : null;
            ...
            appBar: AppBar(
              ...
              title: Text(
                FFLocalizations.of(context).getText(
                  'lyd7tf2y' /* Historial de Servicios */,
                ),
                    ...
                    child: StreamBuilder<List<CitasRecord>>(
                      stream: queryCitasRecord(
                        queryBuilder: (citasRecord) => citasRecord.where(
                          'nombreCliente',
                          isEqualTo: historialClienteCitasRecord?.nombreCliente,
                          isNull:
                              (historialClienteCitasRecord?.nombreCliente) ==
                                  null,
                        ),
                      ),
                      builder: (context, snapshot) {
