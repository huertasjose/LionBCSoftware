...
class _CarritoWidgetState extends State<CarritoWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Carrito'});
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          '₡ ${containerProductosRecord.precioVenta.toString()}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                        ...
                        Padding(
                          ...
                          child: StreamBuilder<List<CarritoRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CarritoRecord>
                                  propertyAddressCarritoRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final propertyAddressCarritoRecord =
                                  propertyAddressCarritoRecordList.isNotEmpty
                                      ? propertyAddressCarritoRecordList.first
                                      : null;
                              ...
                              return FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await launchUrl(Uri(
                                      ...
                                      query: {
                                        'subject':
                                            'Confirmación de pedido en LionBarber BC',
                                        'body':
                                            'Se realizó su pedido en la barbería Lion BC Le recordamos que los productos apartados tiene 15 días de expiración, si este no es retirado antes de los 15 días la reserva del producto será canceladaProductos adquiridos:',
                                      }
                                          .entries
