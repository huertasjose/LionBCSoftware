...
class _EditarPerfilWidgetState extends State<EditarPerfilWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.getUser = await UsersRecord.getDocumentOnce(currentUserReference!);
      safeSetState(() {
        _model.textController1?.text = currentUserDisplayName;
      });
      safeSetState(() {
        _model.emailAddressTextController?.text = currentUserEmail;
      });
      safeSetState(() {
        _model.telefonoTextController?.text = currentPhoneNumber;
      });
    });
