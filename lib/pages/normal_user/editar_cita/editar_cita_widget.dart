...
class EditarCitaWidget extends StatefulWidget {
  const EditarCitaWidget({
    super.key,
    required this.citaReferencia,
  });

  final DocumentReference? citaReferencia;
...
class _EditarCitaWidgetState extends State<EditarCitaWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'EditarCita'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.getCita =
          await CitasRecord.getDocumentOnce(widget!.citaReferencia!);
      safeSetState(() {
        _model.nombreTextController?.text = _model.getCita!.nombreCliente;
      });
      safeSetState(() {
        _model.telefonoTextController?.text = _model.getCita!.telefonoCliente;
      });
      safeSetState(() {
        _model.correoTextController?.text = _model.getCita!.correoCliente;
      });
      safeSetState(() {
        _model.dropDownValueController?.value = _model.getCita!.hora;
      });
      safeSetState(() {
        _model.fechaTextController?.text = dateTimeFormat(
          "yMMMd",
          _model.getCita!.fecha!,
          locale: FFLocalizations.of(context).languageCode,
        );
      });
      safeSetState(() {
        _model.barberoSelectValueController?.value = _model.getCita!.barbero;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CitasRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CitasRecord> editarCitaCitasRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editarCitaCitasRecord = editarCitaCitasRecordList.isNotEmpty
            ? editarCitaCitasRecordList.first
            : null;
                                ...
                                StreamBuilder<List<EmpleadosRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<EmpleadosRecord>
                                        barberoSelectEmpleadosRecordList =
                                        snapshot.data!;

                                    return FlutterFlowDropDown<String>(
                                      controller: _model
                                              .barberoSelectValueController ??=
                                          FormFieldController<String>(null),
                                      options: barberoSelectEmpleadosRecordList
                          ...
                          onPressed: () async {
                            ...
                            if (_model.citaEncontrada != null &&
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Barbero no disponibl para esa fecha',
                                    style: FlutterFlowTheme.of(context)
                                        .titleLarge
                                        .override(
                                          font: GoogleFonts.poppins(
                              ...
                              var confirmDialogResponse =
                                  await showDialog<bool>(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title:
                                                Text('¿Desea editar su cita?'),
                                            content: Text(
                                                'La fecha de la cita será modificada'),
                                            actions: [
                                              TextButton(
                              ...
                              if (confirmDialogResponse) {
                                await widget!.citaReferencia!
                                    .update(createCitasRecordData(
                                  hora: _model.dropDownValue,
                                  barbero: _model.barberoSelectValue,
