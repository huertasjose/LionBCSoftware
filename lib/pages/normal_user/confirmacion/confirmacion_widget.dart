...
class _ConfirmacionWidgetState extends State<ConfirmacionWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'confirmacion'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().fechaReserva = FFAppState().fechaReserva;
      FFAppState().horaReserva = FFAppState().horaReserva;
      FFAppState().barberoSeleccionado = FFAppState().barberoSeleccionado;
      safeSetState(() {});
    });
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'oe4rjcuz' /* Tu cita ha sido programada exi... */,
                    ),
                    textAlign: TextAlign.center,
