                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'uwqp8w7i' /* Let us know what you thought o... */,
                          ),
                          textAlign: TextAlign.start,
                          style:
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'imn09gjc' /* How would you rate it? */,
                            ),
                            textAlign: TextAlign.start,
                            style:
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: FFLocalizations.of(context).getText(
                        'z78y4mja' /* Please leave a descriptio... */,
                      ),
                      hintStyle:
                          FlutterFlowTheme.of(context).bodyMedium.override(
                                font: GoogleFonts.urbanist(
